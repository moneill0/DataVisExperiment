...
// append the svg object to visualization #2
...
svg.selectAll("dot")
    ...
    .attr("r", function (d, i) {
        ...
        } else if (i == 8 || i == 9) { // these are the points that will have a fixed radius size
            d3.select(this).style("opacity", 0.3); // makes the circle opaque
            return 15; // radius size is 15
        } else {
